...
public class Start {
	public static void main(String[] args) {
		...
		for (int i = 0; i < 4; i++) {
			...
			/*
			 * Até aqui o objecto está todo preenchido Então vamos usar uma váriavel do tipo
			 * objecto para adicionar o nosso objecto todo dentro do array, (n sei fazer
			 * directo)... Criei o people que get* pega todos os elementos preenchidos
			 */
