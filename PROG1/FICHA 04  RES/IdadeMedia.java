// EX8 Calcule a idade média de homens, mulheres e todo um grupo de n estudantes.
import java.util.Scanner;
public class IdadeMedia{
	public static void main(String[] args){
	Scanner ler = new Scanner(System.in);
	int idadeH, idadeM, idadeT;
// escolhi double pois é mais preciso; mais casas decimais significa maior precisão
	char resp='s';
